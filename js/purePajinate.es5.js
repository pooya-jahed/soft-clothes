 ...
 */
var purePaginate = /*#__PURE__*/function () {
  "use strict";

  function purePaginate(options) {
    _classCallCheck(this, purePaginate);
  ...
  _createClass(purePaginate, [{
    ...
    value: function init() {
      ...
      var more = '<li class="ellipse more page-item"><span>...</span></li>';
      var less = '<li class="ellipse less page-item"><span>...</span></li>';
      var first = !this.config.showFirstLast ? '' : '<li class="first_link page-item ' + this.config.defaultClass + '"><a class="page-link"  href="" aria-label= "' + this.config.navAriaLabelFirst + '" onclick="return false;">' + this.config.navLabelFirst + '</a></li>';
      var last = !this.config.showFirstLast ? '' : '<li class="last_link page-item ' + this.config.defaultClass + '"><a class="page-link"  href="" aria-label=" ' + this.config.navAriaLabelLast + '" onclick="return false;">' + this.config.navLabelLast + '</a></li>';
      var previous = !this.config.showPrevNext ? '' : '<li class="previous_link page-item ' + this.config.defaultClass + '"><a  class="page-link" href="" aria-label=" ' + this.config.navAriaLabelPrev + '" onclick="return false;">' + this.config.navLabelPrev + '</a></li>';
      var next = !this.config.showPrevNext ? '' : '<li class="next_link page-item ' + this.config.defaultClass + '"><a class="page-link"  href="" aria-label="' + this.config.navAriaLabelNext + '" onclick="return false;">' + this.config.navLabelNext + '</a></li>';
      var navigation_html = '<ul class="pagination justify-content-center">';
        ...
        switch (this.config.navOrder[_i]) {
          ...
          case "num":
            ...
            while (number_of_pages > current_link) {
              ...
              navigation_html += '<li class="page_link' + extra_class + ' ' + this.config.defaultClass + '" longdesc="' + current_link + '"><a class="page-link" href="" aria-label="' + (current_link + 1) + '" onclick="return false;"><span>' + (current_link + 1) + '</span></a></li>';
              current_link++;
            }
